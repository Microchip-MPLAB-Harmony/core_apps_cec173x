...
var repo_name = "core_apps_cec173x";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 driver and system service application examples for CEC173x family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/core_apps_cec173x/assets/css/just-the-docs-' + theme + '.css');
}
